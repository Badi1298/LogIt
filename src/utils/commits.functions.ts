...
const analyzeWeeklyCommits = createServerFn({ method: "POST" })
	...
	.handler(async ({ data: commits }) => {
        ...
        4. For each ticket, alongside the sum of all the hours, provide in parentheses the time spend on the task each day of the week including the date, formatted as: (Mon 26th: 1h 30m, Tue 27th: 2h, Wed 28th: 0h 45m, Thu 29th: 3h, Fri 30th: 1h 15m). If a day has no time logged for that ticket, omit it from the parentheses.
